...
function getUniqueContext(id) {
    if (id >= 18 && id <= 18) return themes[1]; // Step 18
    if (id >= 19 && id <= 19) return themes[2]; // Step 19
    if (id >= 20 && id <= 20) return themes[3]; // Step 20
    if (id >= 21 && id <= 21) return themes[4]; // Step 21
    if (id >= 22 && id <= 22) return themes[5]; // Step 22
